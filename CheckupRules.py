...
rc.send("\n")
time.sleep(15)
rc.send('mgmt_cli -r true set threat-rule rule-number 1 layer "Standard Threat Prevention" comments "Security Checkup Policy" protected-scope "Any" action "Security_Checkup" install-on "Policy Targets" --format json')
rc.send("\n")
time.sleep(5)
